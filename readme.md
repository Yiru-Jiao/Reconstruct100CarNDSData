...
Note that 75% of the single vehicle crashes were low-g force physical contact or tire strikes; in other words, most of the crashes involved very minor physical contact[^1]. 
[^1]: Neale, V.L., Dingus, T.A., Klauer, S.G., Sudweeks, J. and Goodman, M., 2005. An overview of the 100-car naturalistic study and findings. National Highway Traffic Safety Administration, 05-0400.

Including time-series sensor data, event context narratives, and manually remarked descriptions of these events, this database is now made public under a license of CC0 1.0. Time series radar data were recorded before and after the event, which can be used to reconstruct the trajectories of the vehicles involved in the event.
